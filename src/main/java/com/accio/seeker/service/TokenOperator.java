...
public record TokenOperator(TokenKeyword keyword, TokenOperand operand, String value) {
  ...
  public enum TokenKeyword {
    NAME, LESSON, POWER, TYPE, KEYWORD, TEXT, PROVIDES, FLAVOR, ARTIST, RARITY, SET, NUMBER, NONE
  }
  public enum TokenOperand{
    EQUALS, GREATER_THAN, LESS_THAN, GREATER_THAN_EQUALS, LESS_THAN_EQUALS, CONTAINS, NONE
  }
